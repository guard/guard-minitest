...
PROJECT_NAME = 'Guard::Minitest'
CURRENT_VERSION = Guard::MinitestVersion::VERSION

def releaser
  $releaser ||= Releaser.new(project_name: PROJECT_NAME, gem_name: 'guard-minitest',
                             github_repo: 'guard/guard-minitest', version: CURRENT_VERSION)
end
